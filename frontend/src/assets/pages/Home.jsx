    ...
    (async () => {
      try {
        ...
        if (
          ...
          console.warn(
            "⚠️ Atributos não encontrados ou vazios. Usuário precisa criar dados mockados."
          );
          throw new Error(
            "Atributos não encontrados. Clique no botão para criar dados mockados."
          );
        }
        ...
        console.log(
          "🔄 Desafios carregados e transformados:",
                  ...
                  {expanded && (
                    <div className="pt-4 mt-4 border-t border-zinc-200">
                      <p className="text-sm text-zinc-700">
                        <span className="font-medium">Objetivo:</span> resolver
                        o desafio aplicando as skills acima e registrando suas
                        decisões técnicas.
                      </p>
                      ...
                      <div className="mt-3 grid gap-2 text-sm text-zinc-700">
                        ...
                        <div>
                          ...
                          clareza do código, testes básicos, comunicação
                          (README) e performance quando aplicável.
                        </div>
                        <div>
                          <span className="font-medium">Passos sugeridos:</span>{" "}
                          entender o bug/feature, planejar, implementar, testar
                          e documentar.
                        </div>
                      </div>
                      ...
                      <div className="mt-5 flex flex-wrap gap-3">
                        ...
                        >
                          <PrimaryButton>Começar desafio</PrimaryButton>
                        </Link>
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-5">
          <Card className="p-5">
            ...
            <p className="mt-1.5 text-sm text-zinc-600">
              Pratique entrevistas técnicas e comportamentais com IA, recebendo
          ...
          <Card className="p-5">
            ...
            <p className="mt-1.5 text-sm text-zinc-600">
              Receba um roteiro de desenvolvimento baseado em suas habilidades e
