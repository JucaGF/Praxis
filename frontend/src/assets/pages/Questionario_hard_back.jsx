...
export default function QuestionarioHardBack() {
  ...
  // Categorização de habilidades por tipo (opções reduzidas e focadas)
  const habilidadesDisponiveis = {
    "Linguagens de Programação (Código)": {
      tipo: "codigo",
      opcoes: ["Python", "Java", "JavaScript", "TypeScript", "Go"]
    },
    "Frameworks & Bibliotecas (Código)": {
      tipo: "codigo",
      opcoes: ["Django", "Flask", "FastAPI", "Spring Boot", "Node.js", "Express.js"]
    },
    "Bancos de Dados (Código)": {
      tipo: "codigo",
      opcoes: ["PostgreSQL", "MySQL", "MongoDB", "Redis"]
    },
    "APIs & Web Services (Código)": {
      tipo: "codigo",
      opcoes: ["REST API", "GraphQL", "WebSockets"]
    },
    "Arquitetura & Design (Planejamento)": {
      tipo: "planejamento",
      opcoes: ["Arquitetura de Software", "Design Patterns", "SOLID", "Microservices"]
    },
    "DevOps & Cloud (Planejamento)": {
      tipo: "planejamento",
      opcoes: ["Docker", "CI/CD", "AWS", "Git"]
    },
    "Testes & Qualidade (Planejamento)": {
      tipo: "planejamento",
      opcoes: ["Testes Automatizados", "TDD", "Code Review"]
    },
    "Documentação & Comunicação (Comunicação)": {
      tipo: "comunicacao",
      opcoes: ["Documentação Técnica", "API Documentation", "Technical Writing"]
    }
  };
  ...
  return (
    <div className="relative h-screen bg-white overflow-hidden flex justify-center items-center py-6">
      ...
      {/* Container centralizado com altura fixa */}
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 h-[calc(100vh-3rem)] flex flex-col">
        {/* Card principal */}
        <div className="bg-white/95 backdrop-blur-sm shadow-2xl rounded-2xl border border-gray-200 flex flex-col h-full overflow-hidden">
