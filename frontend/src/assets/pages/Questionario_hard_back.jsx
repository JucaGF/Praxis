...
export default function QuestionarioHardBack() {
  ...
  const perguntas = [
    {
      ...
      questoes: ["Python", "Java", "JavaScript", "Ruby", "C#"],
    },
    {
      categoria: "Banco de Dados",
      questoes: ["Gerenciamento de banco de dados"],
    },
    {
      categoria: "APIs e Segurança",
      questoes: ["Conhecimento sobre API", "Práticas de segurança"],
    },
    {
      categoria: "Conceitos e Arquitetura",
      questoes: ["Programação orientada a objetos", "Arquitetura de software"],
    },
    {
  ...
  if (mostrarSaudacao) {
    return (
      <div className="relative h-[85vh] flex justify-center items-center bg-white overflow-hidden">
        <FundoAnimado />

        <div className="relative z-10 w-full max-w-3xl mx-auto bg-white/95 backdrop-blur-sm shadow-2xl rounded-3xl border border-gray-200 p-10 flex flex-col items-center text-center">
          <img src="/Logo.png" alt="Praxis" className="w-40 h-40 mb-6" />
          <h1 className="text-3xl font-semibold text-gray-800 mb-4">
            Questionário de Hard Skills (Backend)
          </h1>
          <p className="text-gray-600 max-w-md text-sm leading-relaxed mb-6">
            ...
            atual em backend. Não se preocupe com respostas certas ou erradas —
