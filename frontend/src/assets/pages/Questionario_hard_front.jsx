...
export default function QuestionarioHardFront() {
  ...
  const perguntas = [
    {
      categoria: "Fundamentos Web",
      questoes: ["HTML", "CSS", "JavaScript"],
    },
    {
    ...
    {
      categoria: "Ferramentas e Frameworks",
      questoes: ["Vite", "Vue", "Angular"],
    },
    {
      categoria: "Linguagens e Estilização",
      questoes: ["TypeScript", "Tailwind CSS"],
    },
  ];
  ...
  const FundoAnimado = () =>
    Array.from({ length: 150 }).map((_, i) => {
      ...
      while (!validPosition) {
        ...
        top = Math.random() * 100;
        const isInFormArea = left > 25 && left < 75 && top > 10 && top < 90;
  ...
  if (mostrarSaudacao) {
    return (
      <div className="relative min-h-screen flex justify-center items-center bg-white overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-3xl h-[75vh] mx-auto bg-white/95 backdrop-blur-sm shadow-2xl rounded-3xl border border-gray-200 p-10 flex flex-col items-center text-center">
          <img src="/Logo.png" alt="Praxis" className="w-40 h-40 mb-6" />
          <h1 className="text-3xl font-semibold text-gray-800 mb-4">
            Questionário de Hard Skills (Frontend)
          </h1>
          <p className="text-gray-600 max-w-md text-sm leading-relaxed mb-6">
            ...
            atual em frontend. Não se preocupe com respostas certas ou erradas —
            seja sincero para que possamos montar o plano ideal para você.
          </p>
          <button
  ...
  return (
    <div className="relative min-h-screen bg-white overflow-hidden flex justify-center items-center">
      ...
      <button
        ...
        className="absolute top-6 left-6 text-gray-600 hover:text-gray-800 font-medium transition flex items-center gap-2 text-sm z-50"
      >
        <svg
          className="w-4 h-4"
          fill="none"
      ...
      <div className="relative z-10 flex flex-col justify-center items-center w-full max-w-3xl h-[75vh] bg-white/95 backdrop-blur-sm shadow-2xl rounded-3xl border border-gray-200 p-10 overflow-hidden">
