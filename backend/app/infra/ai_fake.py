            ...
            "template_code": [
                {
                    ...
                    "fields": [
                        {"id": "protocolo", "label": "Protocolo de Comunicação", "type": "dropdown",
                         "options": ["WebSocket", "Server-Sent Events (SSE)", "Long Polling"]},
                        {"id": "message_broker", "label": "Message Broker", "type": "dropdown",
                            "options": ["Redis Pub/Sub", "RabbitMQ", "Kafka", "Não usar"]},
                        {"id": "armazenamento", "label": "Armazenamento",
                            "type": "dropdown", "options": ["PostgreSQL", "MongoDB", "Redis"]}
                    ]
                },
                {
                    "id": "justificativa",
                    "label": "Justificativa",
                    "fields": [
                        {"id": "porque", "label": "Por que escolheu essas tecnologias?",
                         "type": "textarea"}
                    ]
                },
                {
                    ...
                    "label": "Trade-offs",
                    "fields": [
                        {"id": "limitacoes", "label": "Principais limitações da solução",
                         "type": "textarea"}
                    ]
                }
            ]
            ...
            "template_code": [
                {
                    ...
                    "fields": [
                        {"id": "onde", "label": "Onde implementar o cache?", "type": "dropdown",
                         "options": ["Redis", "Memcached", "Application Memory", "CDN"]},
                        {"id": "ttl", "label": "TTL (Time To Live)", "type": "dropdown", "options": [
                            "30 segundos", "5 minutos", "1 hora", "Sem TTL"]},
                        {"id": "pattern", "label": "Padrão de Cache", "type": "dropdown",
                ...
                },
                {
                    ...
                    "label": "Invalidação",
                    "fields": [
                        {"id": "quando", "label": "Como invalidar o cache?",
                         "type": "textarea"},
                        {"id": "granularidade", "label": "Granularidade", "type": "dropdown",
                            "options": ["Cache completo", "Por produto", "Por categoria"]}
                    ]
                },
                {
                    "id": "tradeoffs",
                    "label": "Trade-offs",
                    "fields": [
                        {"id": "problemas", "label": "Problemas potenciais dessa estratégia",
                         "type": "textarea"}
                    ]
                }
            ]
            ...
            "template_code": [
                {
                    ...
                    "label": "Orquestração",
                    "fields": [
                        {"id": "ferramenta", "label": "Ferramenta de Orquestração", "type": "dropdown",
                         "options": ["Apache Airflow", "Prefect", "Dagster", "Cron Jobs"]},
                        {"id": "schedule", "label": "Schedule", "type": "dropdown",
                            "options": ["Diário 00:00", "Diário 06:00", "A cada 6 horas"]},
                        {"id": "retries", "label": "Retries em caso de falha",
                            "type": "dropdown", "options": ["0", "2", "3", "5"]}
                    ]
                },
                {
                    "id": "idempotencia",
                    "label": "Idempotência",
                    "fields": [
                        {"id": "estrategia", "label": "Como garantir idempotência?",
                         "type": "textarea"}
                    ]
                },
                {
                    ...
                    "label": "Monitoramento",
                    "fields": [
                        {"id": "alertas", "label": "Quando alertar?",
                            "type": "textarea"},
                        {"id": "metricas", "label": "Métricas principais",
                         "type": "textarea"}
                    ]
                }
            ]
...
class FakeAI(IAIService):
    ...
    def evaluate_submission(self, challenge: dict, submission: dict) -> dict:
        ...
        if ch_type == "planejamento":
            base = 78
        if ch_type == "texto_livre":
            base = 85

        metrics = (
            {"resolveu_problema": base, "qualidade_codigo": base -
                3, "boas_praticas": base-5}
